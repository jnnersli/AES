...
public class NewDriver{
	...
	public static short[][] keyExpansionTest(){
		...
		short[][] somebuddy = AES.keyExpansion10(key);
	...
	public static short[][] addRoundKeyTest(short[] key2, short[][] plainerText ){
		...
		short[][] addedMtx = AES.addRoundKey(key2,plainerText);
		System.out.println("***********************");
	...
	public static short[][] subBytesTest(short[][] alteredMtx){
		...
		short[][] subbedMtx = AES.subBytes(alteredMtx);
		System.out.println("***********************");
	...
	public static short[][] shiftRowTest(short[][] subbdedMtx){
		...
		short[][] shiftedMtx = AES.shiftRows(subbdedMtx);
